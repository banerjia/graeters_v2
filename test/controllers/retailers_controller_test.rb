...
class RetailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retailer" do
    assert_difference("Retailer.count") do
      post retailers_url, params: { retailer: { active: @retailer.active, name: @retailer.name, url: @retailer.url } }
    end
  ...
  test "should update retailer" do
    patch retailer_url(@retailer), params: { retailer: { active: @retailer.active, name: @retailer.name, url: @retailer.url } }
